...
class Usuarios extends BaseController
{
  ...
  $this->iniciarSesionAutomatica($this->request->getPost('correo'));
    ...
    public function registro()
    {
        ...
        if ($tipoDocumento == 'dni') {
            $rules['dni'] = 'required|max_length[20]';
        ...
        if ($tipoDocumento == 'dni') {
            ...
            $data['documento_numero'] = $this->request->getPost('dni');
            $data['nombre'] = $this->request->getPost('nombre');
        } elseif ($tipoDocumento == 'ruc') {
            $data['documento_tipo'] = 'ruc';
            $data['documento_numero'] = $this->request->getPost('ruc');
            $data['nombre'] = $this->request->getPost('razonSocial');
            $data['contacto'] = $this->request->getPost('contacto');
            $data['nombre_c'] = $this->request->getPost('nombre_c');
        }
