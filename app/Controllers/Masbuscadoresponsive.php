...
class Masbuscadoresponsive extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->bannertiendaModel = new MasbuscadoresponsiveModel();
    }
    ...
    public function index()
    {
        ...
        return view('admin/masbuscadoresponsive', $data);
    }
    ...
    public function store()
    {
        ...
        $bannertiendaModel = new MasbuscadoresponsiveModel();
        ...
        if ($this->request->getPost()) {
            ...
            if (empty($id)) {
                ...
                if ($this->validate($validationRules)) {
                    ...
                    $imageFile->move(ROOTPATH . 'public/assets/image/img_tienda/masbuscadoresponsive', $newFileName);
                    $uploadedPath = ROOTPATH . 'public/assets/image/img_tienda/masbuscadoresponsive/' . $newFileName;
                    $webpPath = ROOTPATH . 'public/assets/image/img_tienda/masbuscadoresponsive/' . pathinfo($newFileName, PATHINFO_FILENAME) . '.webp';
                ...
                if ($this->validate($validationRules)) {
                    if ($this->request->getFile('imagenbanner')->isValid() && !$this->request->getFile('imagenbanner')->hasMoved()) {
                        ...
                        if ($oldImage && file_exists(ROOTPATH . 'public/assets/image/img_tienda/masbuscadoresponsive/' . $oldImage)) {
                            unlink(ROOTPATH . 'public/assets/image/img_tienda/masbuscadoresponsive/' . $oldImage);
                        }
                        $data['imagenbanner'] = pathinfo($newFileName, PATHINFO_FILENAME) . '.webp';
                    }
