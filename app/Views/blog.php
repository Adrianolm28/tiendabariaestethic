    ...
    <nav class="m-nav">
        ...
        <div class="logo">
            <a href="<?php echo base_url('/'); ?>">
                <img src="./assets/image/others/logo/logo-vale1.png" alt="logo-thumb" />
            </a>
        </div>
        <ul class="nav-links">
            ...
            <li class="dropdown"><a href="<?php echo base_url('#planesSelect'); ?>">Planes </a>

                <ul class="d-menu">
                    <li><a href="portfolio.html">Portfolio</a></li>
                    <li><a href="protfolio-detalis.html">protfolio-detalis</a></li>
                </ul>

            </li>
            <li class="dropdown">
                <a href="<?php echo base_url('#servicioSelect'); ?>">Caracteristicas</a>

                <ul class="d-menu">
                    <li><a href="home-one-service.html">Soporte</a></li>

                </ul>

            </li>
            <li class="dropdown"><a href="home-1-blog.html">Blog</a>

                <ul class="d-menu">
                    <li><a href="home-1-blog.html">Blog</a></li>
                    <li><a href="home-1-blog-2.html">Blog-02</a></li>
                    <li><a href="home-1blog-detalis.html">Blog-detalis</a></li>
                </ul>
            ...
            <li class="dropdown"><a href="shop.html">pages</a>
                ...
                <ul class="d-menu">
                    ...
                    <li>
                        <a href="countact-me.html">countact-me</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="team-detalis.html"> Team-Details</a>
                    </li>
...
<main>
    ...
    <section class=" h-1-blog">
        <div class="container">
            <div class="row ">
                <div class="col-lg-12">
                    <div class="blog-head">
                        <h2>Manténgase al día con nuestras noticias.</h2>
                        <div class="blog-vic">
            ...
            <div class="row b-h-1-mt-2 ">
                <div class="col-lg-8 col-md-6">
                    <div class="row">
                            ...
                            <div class="blog-item">
                                ...
                                <div class="blog-inner">
                                    ...
                                    <div class="blog-inner-text">
                                        <a href="<?php echo base_url('/blog_detalle'); ?>">The highly Creative UI/UX Workflow from a Silicon Valley.</a>
                                    </div>
                                    <div class="blog-btn">
                                        <a href="#">3 days read</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <div class="blog-item">
                                ...
                                <div class="blog-inner">
                                    ...
                                    <div class="blog-inner-text">
                                        <a href="home-1blog-detalis.html">Creativo para jóvenes: a Designer’s UI/UX complete checklist.</a>
                                    </div>
                                    <div class="blog-btn">
                                        <a href="#">3 days read</a>
                                    </div>
                        ...
                        <div class="col-lg-6  b-h-1-mt">
                            <div class="blog-item">
                                <div class="blog-img">
                                    <img src="./assets/image/others/h-1-b-1.png" alt="blog-thumb" />
                                </div>
                                <div class="blog-inner">
                                    <div class="blog-inner-btn">
                                        <a href="#">Digital</a>
                                    ...
                                    <div class="blog-inner-text">
                                        <a href="home-1blog-detalis.html">Organic food isn't much Better for your Future
                                            Health.</a>
                                    </div>
                                    <div class="blog-btn">
                                        <a href="#">3 days read</a>
                        ...
                        <div class="col-lg-6 b-h-1-mt">
                            <div class="blog-item">
                                <div class="blog-img">
                                    <img src="./assets/image/others/h-1-b-1-3.png" alt="blog-thumb" />
                                </div>
                                <div class="blog-inner">
                                    <div class="blog-inner-btn">
                                        <a href="#">Digital</a>
                        ...
                        <div class="col-lg-6  b-h-1-mt">
                            <div class="blog-item">
                                <div class="blog-img">
                                    <img src="./assets/image/others/h-1-b-1-2.png" alt="blog-thumb" />
                                </div>
                                <div class="blog-inner">
                                    <div class="blog-inner-btn">
                                        <a href="#">Digital</a>
                        ...
                        <div class="col-lg-6  b-h-1-mt">
                            <div class="blog-item">
                                <div class="blog-img">
                                    <img src="./assets/image/others/h-1-b-1-5.png" alt="blog-thumb" />
                                </div>
                                <div class="blog-inner">
                                    <div class="blog-inner-btn">
                                        <a href="#">Digital</a>
                ...
                <div class="col-lg-4 col-md-6 b-pl">
                    <div class="sarch-box">
                        <div class="sarch-box-head">
                            <h2>Search</h2>
                        </div>
                    ...
                    <div class="latest-box">
                        <div class="latest-box-head">
                            <h2>Ultimas publicaciones</h2>
                        </div>
                        <div class="latest-box-item">
                            <div class="latest-box-inner">
                                <div class="latest-box-img">
                                    <a href="#"> <img src="./assets/image/others/latest-box-1.png" alt="thumb"></a>
                                </div>
                                <div class="latest-box-text">
                                    <a href="home-1blog-detalis.html">The Start-Up Ultimate Guide to Make ....</a>
                                    <p><span><img src="./assets/image/others/icon/Icon.png" alt="icon"></span>31 May 2023</p>
                                </div>
                            </div>
                            <div class="latest-box-inner">
                                <div class="latest-box-img">
                                    <a href="#"> <img src="./assets/image/others/latest-box-3.png" alt="thumb"></a>
                                </div>
                                <div class="latest-box-text">
                                    <a href="home-1blog-detalis.html">Definitive Guide to Make a Daily ....</a>
                                    <p><span><img src="./assets/image/others/icon/Icon.png" alt="icon"></span>31 May 2023</p>
                                </div>
                            </div>
                            <div class="latest-box-inner">
                    ...
                    <div class="categories">
                        ...
                        ?>
                        <div class="categories-box-head">
                            <h2>Categorias</h2>
                        </div>
                        <!-- <div class="categories-item">
                                <div class="categories-item-text">
                                    <a href="#">Mobile UI <span>(232)</span></a>
                                </div>
                                <div class="categories-item-text">
                                    <a href="#">Saas Landing <span>(343)</span></a>
                                </div>
                                <div class="categories-item-text">
                                    <a href="#">Product UI <span>(4564)</span></a>
                                </div>
                                <div class="categories-item-text">
                                    <a href="#">Wireframing  <span>(343)</span></a>
                                </div>
                                <div class="categories-item-text">
                                    <a href="#">Style Guide <span>(8374)</span></a>
                                </div>
                            </div> -->
                        <div class="categories-item">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="skill-right">
                        <p>I am product designer, who are excited about unique ideas and help.</p>
                    </div>
                    <div class="skill-rigght-btn">
                        <div class="btn-style-1">
                            <a href="#">Download CV
                                <span><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9.00077 0.5625C8.79391 0.56255 8.59555 0.644744 8.44928 0.791012C8.30301 0.937279 8.22082 1.13565 8.22077 1.3425V10.2409L5.23783 7.25794C5.16539 7.18551 5.07939 7.12806 4.98475 7.08887C4.89011 7.04967 4.78867 7.0295 4.68623 7.02951C4.47935 7.02953 4.28095 7.11173 4.13467 7.25803C3.9884 7.40433 3.90623 7.60275 3.90625 7.80963C3.90627 8.01651 3.98847 8.21491 4.13477 8.36119L8.44914 12.675C8.59548 12.8212 8.79389 12.9034 9.00077 12.9034C9.20765 12.9034 9.40606 12.8212 9.55239 12.675L13.8668 8.36044C14.0131 8.21416 14.0953 8.01576 14.0953 7.80888C14.0953 7.602 14.0131 7.40358 13.8669 7.25728C13.7206 7.11098 13.5222 7.02878 13.3153 7.02876C13.1084 7.02875 12.91 7.11091 12.7637 7.25719L9.78077 10.2409V1.3425C9.78072 1.13565 9.69852 0.937279 9.55226 0.791012C9.40599 0.644744 9.20762 0.56255 9.00077 0.5625Z" />
                                        <path d="M1.3425 10.876C1.13563 10.876 0.937235 10.9582 0.790957 11.1044C0.644678 11.2507 0.5625 11.4491 0.5625 11.656V14.2262C0.563443 15.0776 0.902079 15.8939 1.50411 16.4959C2.10615 17.098 2.92241 17.4366 3.77381 17.4375H14.2262C15.0776 17.4366 15.8939 17.098 16.4959 16.4959C17.0979 15.8939 17.4366 15.0776 17.4375 14.2262V11.656C17.4375 11.5535 17.4173 11.4521 17.3781 11.3575C17.3389 11.2628 17.2815 11.1769 17.209 11.1044C17.1366 11.032 17.0506 10.9746 16.956 10.9354C16.8614 10.8962 16.7599 10.876 16.6575 10.876C16.5551 10.876 16.4536 10.8962 16.359 10.9354C16.2644 10.9746 16.1784 11.032 16.106 11.1044C16.0335 11.1769 15.9761 11.2628 15.9369 11.3575C15.8977 11.4521 15.8775 11.5535 15.8775 11.656V14.2262C15.877 14.664 15.7029 15.0838 15.3933 15.3933C15.0837 15.7029 14.664 15.877 14.2262 15.8775H3.77381C3.33601 15.877 2.91628 15.7029 2.60671 15.3933C2.29713 15.0838 2.123 14.664 2.1225 14.2262V11.656C2.12252 11.5535 2.10237 11.4521 2.06318 11.3575C2.02399 11.2628 1.96653 11.1768 1.8941 11.1044C1.82166 11.0319 1.73567 10.9745 1.64102 10.9353C1.54638 10.8961 1.44494 10.876 1.3425 10.876Z" />
                                    </svg>
