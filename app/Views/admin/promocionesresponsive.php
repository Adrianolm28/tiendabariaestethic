                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <button id="btnAgregarPromocion" class="btn btn-primary" type="button">
                        ...
                        <div class="modal fade" id="myModalAgregar">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form method="post" action="<?php echo site_url('admin/promocionesresponsive/store'); ?>" id="addPromocion" name="addPromocion" enctype="multipart/form-data">
                        ...
                        <div class="modal fade" id="myModalEditar">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form method="post" action="<?php echo site_url('admin/promocionesresponsive/store'); ?>" id="editPromocion" name="editPromocion" enctype="multipart/form-data">
...
<script>
    $(document).ready(function() {
        ...
        $('#addPromocion').on('submit', function(event) {
        ...
        $('body').on('click', '.btnEdit', function() {
            ...
            $.ajax({
                url: '<?= site_url('admin/promocionesresponsive/edit/') ?>' + id,
                type: 'GET',
                dataType: 'json',
                success: function(res) {
                    if (res.status) {
                        ...
                        if (res.data.imagenbanner) {
                            $('#edit_lim').html('<img src="<?= base_url('public/assets/image/img_tienda/promocionesresponsive/'); ?>' + res.data.imagenbanner + '" style="max-width: 200px; max-height: 150px;">');
                        } else {
        ...
        $('body').on('click', '.btnDelete', function() {
            ...
            Swal.fire({
                ...
                $.ajax({
                    url: '<?= site_url('admin/promocionesresponsive/actualizar_estado/') ?>' + id + '/' + newStatus,
                    type: 'POST',
                    dataType: 'json',
                    success: function(res) {
                        location.reload();
