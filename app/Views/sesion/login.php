...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="../../index2.html"><b>Iniciar Sesion</a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
      ...
      <div class="card-body login-card-body">
        ...
        <?php endif; ?>
        <form action="<?= site_url('sesion/login/process') ?>" method="post">
  ...
  <!-- AdminLTE App -->
  <script src="<?php echo base_url('public/assets/admin') ?>/dist/js/adminlte.min.js"></script>
</body>
